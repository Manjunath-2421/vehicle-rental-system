create database if not exists `a049`;
...
('admin', 'goog', 'tn09678', '2023-03-28', '2023-03-29', '500', '-', '1', '300', 'MANJU', '2022-10-27', 0, 11, '5'),
('admin', 'goog', 'tn09678', '2022-11-02', '2022-11-04', '500', '-', '2', '1000', 'manjunath', NULL, 0, 12, '5'),
('admin', 'MG HECTOR', 'TN 02 BA 5861', '2023-02-05', '2023-01-06', '2500', '-', '1', '2000', 'shivapuram', NULL, 0, 13, '6');
...
('Manju', 'chennai', 'village high road', '515870', '25468975232', 'admin', 'admin');
...
('Manju', '2003-06-18', '2/41 oc colony', '5645652546', 'jdjdsbfabfba@gmail.com', '5462485215', '605555703022', 'admin', 'admin', 1);
